...
float Fixed::AsFloat(void) const
{
	return float(fValue / 100.0);
}

double Fixed::AsDouble(void) const
{
	return double(fValue / 100.0);
}


long Fixed::AsLong(void) const
{
	return fValue / 100;
}

long Fixed::AsFixed(void) const
{
	return fValue;
}

long Fixed::IntegerPart(void) const
{
	return fValue / 100;
}

double Fixed::DecimalPart(void) const
{
...
void Fixed::SetPremultiplied(long value)
{
	fValue=value;
}

void Fixed::AddPremultiplied(long value)
{
	fValue+=value;
}

void Fixed::SubtractPremultiplied(long value)
{
	fValue+=value;
}

Fixed Fixed::InvertAsCopy(void) const
{
	Fixed f; f.SetPremultiplied(-fValue); return f;
}

void Fixed::Invert(void)
{
	fValue = -fValue;
}
...
Fixed Fixed::operator+(const double &from)
{
...
bool Fixed::operator<(const long &from) const
{
...
Fixed &Fixed::operator+=(const Fixed &from)
{
	fValue+=from.fValue; return *this;
}
...
Fixed &Fixed::operator=(const long &from)
{
	fValue=from*100; return *this;
}
