...
StickyDrawButton::StickyDrawButton(BRect frame, const char *name, BBitmap *up, 
...
void StickyDrawButton::SetDisabled(BBitmap *disabledup, BBitmap *disableddown)
{
	delete fDisabledUp;
	delete fDisabledDown;
...
void StickyDrawButton::MouseUp(BPoint pt)
{
	BButton::MouseUp(pt);
...
void StickyDrawButton::Draw(BRect update)
{
	// if down
