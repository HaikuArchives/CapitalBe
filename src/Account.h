...
typedef enum { ACCOUNT_BANK = 0, ACCOUNT_CASH, ACCOUNT_CREDIT } AccountType;
...
class Account : public Notifier {
  public:
	...
	void
	DoForEachTransaction(void (*TransactionIteratorFunc)(const TransactionData&, void*), void* ptr);
