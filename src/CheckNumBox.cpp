...
filter_result CheckNumBoxFilter::KeyFilter(const int32 &key, const int32 &mod)
{
...
CheckNumBox::CheckNumBox(const BRect &frame, const char *name, const char *label,
...
bool CheckNumBox::Validate(void)
{
	if(strlen(Text())<1)
	{
