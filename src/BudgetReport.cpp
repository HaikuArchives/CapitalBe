...
void ReportWindow::ComputeBudget(void)
{
	...
	for(i = 0; i < timelist.CountItems() - 1; i++)
	{
		...
		fGridView->AddColumn(new BStringColumn(columntitle,maxwidths[i + 1],
												10,300,B_TRUNCATE_END),i + 1);
	}
