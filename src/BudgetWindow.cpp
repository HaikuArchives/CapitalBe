...
BudgetWindow::BuildStatsAndEditor(void)
{
	...
	fCatStat->AddColumn(
		new BStringColumn(B_TRANSLATE("12 month statistics"), statwidth, 10, 300, B_TRUNCATE_END), 0
	);
	fCatStat->AddColumn(
...
BudgetWindow::BuildBudgetSummary(void)
{
	...
	fBudgetSummary->AddColumn(
		new BStringColumn(
			B_TRANSLATE("Total"), fBudgetSummary->StringWidth(B_TRANSLATE("Total")) + 20, 10, 300,
...
BudgetWindow::BuildCategoryList(void)
{
	...
	fCategoryList->AddColumn(
		new BStringColumn(
			B_TRANSLATE("Amount"), fCategoryList->StringWidth(B_TRANSLATE("Amount")) + 20, 10, 300,
			B_TRUNCATE_END, B_ALIGN_RIGHT
		),
		1
	);
	fCategoryList->AddColumn(
		new BStringColumn(
			B_TRANSLATE("Frequency"), fCategoryList->StringWidth(B_TRANSLATE("Frequency")) + 20, 10,
