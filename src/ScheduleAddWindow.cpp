...
ScheduleAddWindow::ScheduleAddWindow(const BRect &frame, const TransactionData &data)
	: BWindow(
		  frame, TRANSLATE("Schedule Transaction"), B_TITLED_WINDOW_LOOK, B_MODAL_APP_WINDOW_FEEL,
	...
	fIntervalMenu->AddItem(new BMenuItem(TRANSLATE("Annually"), new BMessage(M_SCHEDULED_ANNUALLY))
	);
