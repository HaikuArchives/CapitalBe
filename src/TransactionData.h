...
public:
	...
	TransactionData(Account *account, const char *date, const char *type, 
				const char *payee, const char *amount, const char *category, 
				const char *memo, uint8 status=TRANS_OPEN);
	...
	status_t Set(Account *account, const char *date, const char *type, 
				const char *payee, const char *amount, const char *category, 
				const char *memo, uint8 status=TRANS_OPEN);
	...
	void SetAmountAt(const int32 &index, const Fixed &amount) { fCategory.SetAmountAt(index,amount); }
