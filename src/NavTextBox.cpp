...
filter_result NavTextBoxFilter::KeyFilter(const int32 &key, const int32 &mod)
{
...
NavTextBox::NavTextBox(const BRect &frame, const char *name, const char *label,
...
bool NavTextBox::Validate(const bool &alert)
{
	return true;
}
